...
export function onInitialization() {
    activePlugins.register(new MaraTestPlugin());
}

export class MaraTestPlugin extends HordePluginBase {
    ...
    public onFirstRun() {
        ...
        let playerNames = MaraUtils.ShuffleArray(new Array(...MaraTestPlugin.playerNames));
